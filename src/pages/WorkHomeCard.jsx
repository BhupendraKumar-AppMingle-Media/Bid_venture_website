        ...
        <div className=" shadow-lg rounded-lg flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="text-center px-4 py-4 w-full">
            ...
            {isPopupVisible && (
              ...
              //   <div className="container-work mx-auto max-w-full sm:max-w-4xl bg-white p-6 sm:p-8 rounded-lg shadow-lg overflow-y-auto max-h-[80vh] relative">
              //     {/* Close Button */}
              //     <button
              //       onClick={togglePopup}
        ...
        <div className=" shadow-lg rounded-lg flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="text-center px-4 py-4 w-full">
            ...
            {isRestaurantPopupVisible && (
              ...
              // <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
              //   <div className="container-work mx-auto max-w-full sm:max-w-4xl bg-white p-6 sm:p-8 rounded-lg shadow-lg relative max-h-[90vh] overflow-y-auto">
              //     {/* Close Button */}
              //     <button
              //       onClick={toggleRestaurantPopup}
              //       className="font-bold top-3 right-3 text-4xl text-gray-700 hover:text-red-500 focus:outline-none"
              //     >
              //       &times;
              //     </button>
