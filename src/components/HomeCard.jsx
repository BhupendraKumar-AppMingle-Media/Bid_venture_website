...
const HomeCard = () => {
     ...
     const [isPopupVisible, setIsPopupVisible] = useState(false);
      ...
      const [isRestaurantPopupVisible,setIsRestaurantPopupVisible]=useState(false);
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-3 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full px-4 md:px-8">
        ...
        <div className="bg-[#ecb07f] shadow-lg rounded-lg flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="text-center px-4 py-4 w-full">
            ...
            <button  onClick={togglePopup} className="explore-btn bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition duration-300 font-semibold">
              Post Your Event Now
            </button>
      ...
      {isPopupVisible && (
        ...
        <div className="bg-[#ecb07f] shadow-lg rounded-lg flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="text-center px-4 py-4 w-full">
            ...
            <button  onClick={toggleRestaurantPopup} className="explore-btn bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition duration-300 font-semibold">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
          <div className="container mx-auto max-w-full sm:max-w-4xl bg-white p-6 sm:p-8 rounded-lg shadow-lg relative max-h-[90vh] overflow-y-auto">
            ...
            <form>
              {/* Owner Name */}
              <div className="mb-6">
                <label htmlFor="owner-name" className="block text-left text-sm sm:text-lg font-medium text-gray-700">
                  Owner Name
                </label>
                <input
                  id="owner-name"
              ...
              {/* Restaurant Name */}
              <div className="mb-6">
                <label htmlFor="restaurant-name" className="block text-left text-sm sm:text-lg font-medium text-gray-700">
                  Restaurant Name
                </label>
                <input
                  id="restaurant-name"
              ...
              {/* City */}
              <div className="mb-6">
                <label htmlFor="city" className="block text-left text-sm sm:text-lg font-medium text-gray-700">
                  City
                </label>
                <input
                  id="city"
              ...
              {/* Email */}
              <div className="mb-6">
                <label htmlFor="email" className="block text-left text-sm sm:text-lg font-medium text-gray-700">
                  Email
                </label>
                <input
                  id="email"
              ...
              {/* Mobile Number */}
              <div className="mb-6">
                <label htmlFor="mobile" className="block text-left text-sm sm:text-lg font-medium text-gray-700">
                  Mobile Number
                </label>
                <input
                  id="mobile"
